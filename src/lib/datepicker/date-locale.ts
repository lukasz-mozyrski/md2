...
export class DateLocale {
  ...
  days = [
    { full: 'Niedziela', short: 'Niedz.', xshort: 'N' },
    { full: 'Poniedziałek', short: 'Pon.', xshort: 'Pn' },
    { full: 'Wtorek', short: 'Wt.', xshort: 'W' },
    { full: 'Środa', short: 'Śr.', xshort: 'Ś' },
    { full: 'Czwartek', short: 'Czw.', xshort: 'Cz' },
    { full: 'Piątek', short: 'Pt.', xshort: 'Pt' },
    { full: 'Soboa', short: 'Sob.', xshort: 'S' },
  ];
